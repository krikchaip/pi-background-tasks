...
Normalize volatile values before snapshotting: task IDs, session IDs, PIDs, timestamps, durations, temp paths, and `/tmp/pi-bg-tasks/<session-pid-run>/...` run directories.
