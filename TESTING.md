...
Normalize volatile values before snapshotting: task IDs, session IDs, PIDs, timestamps, durations, temp paths, and `<system-temp>/pi-bg-tasks/<session-pid-run>/...` run directories.
